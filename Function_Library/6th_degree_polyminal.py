...
class PolynomialVAE(nn.Module):
    def __init__(self, latent_dim=12):
        ...
        # 编码器 (Encoder)
        self.encoder_input = nn.Linear(7, 64)
        ...
        self.decoder_output = nn.Linear(256, 7)
...
def train_vae(model, train_loader, num_epochs=600, lr=1e-3):
...
def main():
    ...
    dataset_file = 'Datasets/6th_degree_polynomial_dataset.pkl'
    ...
    save_model(model, 'Model_Library/6th_degree_polynomial_vae_model.pt')
