...
class CoefficientDataset(Dataset):
    def __init__(self, polynomials):
        ...
        for poly in tqdm(polynomials):
            ...
            coeffs = [expanded.coeff(x, i) for i in range(5)]
...
class PolynomialVAE(nn.Module):
    def __init__(self, latent_dim=12):
        ...
        # 编码器 (Encoder)
        self.encoder_input = nn.Linear(5, 64)
        ...
        self.decoder_output = nn.Linear(256, 5)
...
def main():
    ...
    dataset_file = 'Datasets/4th_degree_polynomial_dataset.pkl'
    ...
    save_model(model, 'Model_Library/4th_degree_polynomial_vae_model.pt')
